	   ...
	   function onSignIn(googleUser) {
	    ...
	    window.fbAsyncInit = function() {
	      ...
	      (function(d, s, id) {
	        ...
	        js.src = "https://connect.facebook.net/en_US/all.js?hash=33b742253aa1292a39d23801f2197517&amp;ua=modern_es6";
...
<div class="container">
		 <div class="row justify-content-center">
			...
			<form id="loginProcess" class="text-center">
				아이디 : <input type="text" id="id" name="id"
								value ="<% if(session.getAttribute("id") != null)
												out.println(session.getAttribute("id"));
												%>" class="form-control"><br/>
				비밀번호 : <input type="password" id="pw" name="pw" class="form-control"><br/>
				<input type="button" value="로그인" onclick="formcheck()" class="form-control">&nbsp; &nbsp; 
				<input type="button" value="회원가입" onclick="javascript:window.location='join.jsp'" class="form-control">
			</form>
			<br>
