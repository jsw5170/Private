...
<nav class="nav navbar-light" style="background-color: #e3f2fd;">
	...
	<a href="Notice.do?bType=2" class="nav-link disabled" tabindex="-1" aria-disabled="true">공지사항</a>
...
<ul class="nav justify-content-end navbar-light" style="background-color: #e3f2fd;">
	...
	<table class="table table-striped" width="800" cellpadding="0" cellspacing="0" border="1">
		...
		<tr>
			...
			<%if(id.equals("manager")) {%>
			<a class="btn btn-primary" href="write_view.do?bType=2" role="button">글작성</a>
			<%}%>
			</div>
			<div class='aside_menu'>
			  <form  action="Notice.do" method="post">
			    <aside style='float: right;'>
			      ...
			      <input name="bType" value="2"  type="hidden">
			...
			<c:when test="${(page.curPage - 1) < 1}">
				<li class="page-item disabled">
					<a class="page-link" href="list.do?bType=2&page=1" tabindex="-1">&lt;&lt;</a>
				</li>
			</c:when>
			<c:otherwise>
			<li class="page-item ">
			...
			<c:when test="${(page.curPage - 1) < 1}">
				<li class="page-item disabled">
				<a class="page-link" href="list.do?bType=2&page=${page.curPage -1 }" tabindex="-1">&lt;</a>
				</li>
			</c:when>
			<c:otherwise>
			<li class="page-item ">
			...
			<c:forEach var="fEach" begin="${page.startPage}" end="${page.endPage}" step="1">
				...
				<c:when test="${page.curPage == fEach}">
					 ...
					 <a class="page-link" href="list.do?bType=2&page=${fEach}">${fEach}</a>&nbsp;
					  </li>
				</c:when>
				<c:otherwise>
				<li class="page-item"><a class="page-link" href="list.do?bType=2&page=${fEach}">${fEach}</a>&nbsp;</li>
				</c:otherwise>
				</c:choose>
			</c:forEach>
			...
			<li class="page-item">
      			<a class="page-link" href="list.do?bType=2&page=${page.curPage + 1 }">&gt;</a>
    		</li>
			</c:when>
			<c:otherwise>
			<li class="page-item disabled">
			...
			<c:when test="${page.curPage == page.totalPage}">
				<li class="page-item disabled">
      			<a class="page-link" href="list.do?bType=2&page=${page.totalPage }">&gt;&gt;</a>
    		</li>	
			</c:when>
			<c:otherwise>
			<li class="page-item">
